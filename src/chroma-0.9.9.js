var chroma;
(function () {
    //  The X11 browser standard color dictionary  //
    var dictionary = {
    ...
    function validChromaChannel (obj) {
        if (typeof obj !== 'object' || obj === null)
            return false;
        return obj instanceof ChromaChannel;
    }
    function validChromaColor (obj) {
        if (typeof obj !== 'object' || obj === null)
            return false;
        return obj instanceof ChromaColor;
    }
    ...
    //  ChromaColor  //
    function ChromaColor (name, red, green, blue, alpha) {
    ...
    ChromaColor.prototype.to = function (model) {
        return to(model, this.channels);
    };
    ChromaColor.prototype.toArray = function (model) {
        var arr = parseModel(to(model, this.channels)).slice(1);
        if (/^hex/g.test(model))
